...
(function () {
  ...
  var RECIPES = [
    {
      ...
      modalBlocks: [
        ...
        {
          title: "抹茶亞麻籽豆乳",
          ingredients: "熟黃豆100克、抹茶粉1/2小匙、亞麻籽（或粉）1/2小匙、水300～400毫升",
          steps: ["黃豆浸泡8～12小時後煮熟。", "所有材料加水打勻即可。"],
        },
      ],
    },
    {
      ...
      modalBlocks: [
        {
          title: "薑黃香料橄欖油煨鱸魚",
          ingredients:
            "鱸魚片1片（約300克）、青花菜1碗、小番茄8顆、薑黃3片（或粉1/2小匙）、薑片3片、大蒜3瓣、檸檬1/6顆、小茴香1/2小匙、彩色胡椒粒1小匙、鹽少許、橄欖油1大匙、水約100～150毫升",
          steps: [
  ...
  function buildModalHtml(blocks) {
    var html = "";
    for (var i = 0; i < blocks.length; i++) {
      ...
      for (var j = 0; j < b.steps.length; j++) {
        html += "<li>" + escapeHtml(b.steps[j]) + "</li>";
      }
      html += "</ol>";
    }
    return html;
  ...
  function init() {
    ...
    function fillModal() {
      ...
      modalBody.innerHTML = buildModalHtml(r.modalBlocks);
    }
